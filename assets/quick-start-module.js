...
function commandMessage(key) {
  var object = {
    ...
    "stable,conda,linux,cuda10.1,python2.7":
    ...
    "stable,conda,linux,cuda10.1,python3.5":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch",
    ...
    "stable,conda,linux,cuda10.1,python3.6":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch",
    ...
    "stable,conda,linux,cuda10.1,python3.7":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch",
    ...
    "stable,conda,macos,cuda10.1,python2.7":
      "conda install pytorch torchvision -c pytorch<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,conda,macos,cuda10.1,python3.5":
      "conda install pytorch torchvision -c pytorch<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,conda,macos,cuda10.1,python3.6":
      "conda install pytorch torchvision -c pytorch<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,conda,macos,cuda10.1,python3.7":
      "conda install pytorch torchvision -c pytorch<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,conda,windows,cuda10.1,python2.7":
      "# PyTorch does not support Python 2.7 on Windows. Please install with Python 3.",
    ...
    "stable,pip,macos,cuda10.1,python2.7":
      "pip install torch torchvision<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,pip,macos,cuda10.1,python3.5":
      "pip3 install torch torchvision<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,pip,macos,cuda10.1,python3.6":
      "pip3 install torch torchvision<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,pip,macos,cuda10.1,python3.7":
      "pip3 install torch torchvision<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",
    ...
    "stable,pip,windows,cuda10.1,python2.7":
      "# PyTorch does not support Python 2.7 on Windows. Please install with Python 3.",
    ...
    "stable,libtorch,linux,cuda10.1,cplusplus":
      "Download here (Pre-cxx11 ABI): <br/><a href='https://download.pytorch.org/libtorch/cu101/libtorch-shared-with-deps-1.2.0.zip'>https://download.pytorch.org/libtorch/cu101/libtorch-shared-with-deps-1.2.0.zip</a><br/><br> Download here (cxx11 ABI): <br/><a href='https://download.pytorch.org/libtorch/cu101/libtorch-cxx11-abi-shared-with-deps-1.2.0.zip'>https://download.pytorch.org/libtorch/cu101/libtorch-cxx11-abi-shared-with-deps-1.2.0.zip</a>",
    ...
    "stable,libtorch,windows,cudanone,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-1.2.0.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-1.2.0.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-debug-1.2.0.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-win-shared-with-deps-debug-1.2.0.zip</a>",

    "stable,libtorch,windows,cuda9.2,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-1.2.0.zip'>https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-1.2.0.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-debug-1.2.0.zip'>https://download.pytorch.org/libtorch/cu92/libtorch-win-shared-with-deps-debug-1.2.0.zip</a>",

    "stable,libtorch,windows,cuda10.1,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-1.2.0.zip'>https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-1.2.0.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-debug-1.2.0.zip'>https://download.pytorch.org/libtorch/cu101/libtorch-win-shared-with-deps-debug-1.2.0.zip'/a>",

    "preview,conda,linux,cuda9.2,python2.7":
      "conda install pytorch torchvision cudatoolkit=9.2 -c pytorch-nightly",

    "preview,conda,linux,cuda10.1,python2.7":
    ...
    "preview,conda,linux,cuda10.1,python3.5":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch-nightly",
    ...
    "preview,conda,linux,cuda10.1,python3.6":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch-nightly",
    ...
    "preview,conda,linux,cuda10.1,python3.7":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch-nightly",
    ...
    "preview,conda,macos,cuda10.1,python2.7":
      "conda install pytorch torchvision -c pytorch-nightly",
    ...
    "preview,conda,macos,cuda10.1,python3.5":
      "conda install pytorch torchvision -c pytorch-nightly",
    ...
    "preview,conda,macos,cuda10.1,python3.6":
      "conda install pytorch torchvision -c pytorch-nightly",
    ...
    "preview,conda,macos,cuda10.1,python3.7":
      "conda install pytorch torchvision -c pytorch-nightly",
    ...
    "preview,conda,windows,cuda10.1,python2.7":
      "# Preview Build With Python 2.7 On Windows Not Supported.",
    ...
    "preview,pip,macos,cuda10.1,python2.7":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html<br /># On MacOS, we provide CPU-only packages, CUDA functionality is not provided",
    ...
    "preview,pip,macos,cuda10.1,python3.5":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html<br /># On MacOS, we provide CPU-only packages, CUDA functionality is not provided",
    ...
    "preview,pip,macos,cuda10.1,python3.6":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html<br /># On MacOS, we provide CPU-only packages, CUDA functionality is not provided",
    ...
    "preview,pip,macos,cuda10.1,python3.7":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html <br /># On MacOS, we provide CPU-only packages, CUDA functionality is not provided",
    ...
    "preview,pip,linux,cuda10.1,python2.7":
    ...
    "preview,pip,linux,cuda10.1,python3.5":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,pip,linux,cuda10.1,python3.6":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,pip,linux,cuda10.1,python3.7":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,pip,windows,cuda10.1,python2.7":
      "# Preview Build With Python 2.7 On Windows Not Supported.",
    ...
    "preview,pip,windows,cuda10.1,python3.5":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,pip,windows,cuda10.1,python3.6":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,pip,windows,cuda10.1,python3.7":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,libtorch,windows,cuda10.1,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu101/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu101/libtorch-win-shared-with-deps-latest.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu101/libtorch-win-shared-with-deps-debug-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu101/libtorch-win-shared-with-deps-debug-latest.zip</a>",
  };
