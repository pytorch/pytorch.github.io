...
function commandMessage(key) {
  var object = {
    ...
    "stable,libtorch,linux,cudanone,cplusplus":
      "Download here (Pre-cxx11 ABI): <br/><a href='https://download.pytorch.org/libtorch/cpu/libtorch-shared-with-deps-1.3.0+cpu.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-shared-with-deps-1.3.0+cpu.zip</a><br/><br> Download here (cxx11 ABI): <br/><a href='https://download.pytorch.org/libtorch/cpu/libtorch-cxx11-abi-shared-with-deps-1.3.0+cpu.zip'>https://download.pytorch.org/libtorch/cpu/libtorch-cxx11-abi-shared-with-deps-1.3.0+cpu.zip</a>",

    "stable,libtorch,linux,cuda9.2,cplusplus":
      "Download here (Pre-cxx11 ABI): <br/><a href='https://download.pytorch.org/libtorch/cu92/libtorch-shared-with-deps-1.3.0+cu92.zip'>https://download.pytorch.org/libtorch/cu92/libtorch-shared-with-deps-1.3.0+cu92.zip</a><br/><br> Download here (cxx11 ABI): <br/><a href='https://download.pytorch.org/libtorch/cu92/libtorch-cxx11-abi-shared-with-deps-1.3.0+cu92.zip'>https://download.pytorch.org/libtorch/cu92/libtorch-cxx11-abi-shared-with-deps-1.3.0+cu92.zip</a>",
