...
function commandMessage(key) {
  var object = {
    ...
    "stable,pip,linux,cudanone,python2.7":
      "pip install https://download.pytorch.org/whl/cpu/torch-1.0.1.post2-cp27-cp27mu-linux_x86_64.whl<br/>pip install torchvision <br/><br/> # if the above command does not work, then you have python 2.7 UCS2, use this command<br/>pip install https://download.pytorch.org/whl/cpu/torch-1.0.1.post2-cp27-cp27m-linux_x86_64.whl",

    "stable,pip,linux,cuda8,python2.7":
      "pip install https://download.pytorch.org/whl/cu80/torch-1.0.1.post2-cp27-cp27mu-linux_x86_64.whl<br/>pip install torchvision<br/><br/># if the above command does not work, then you have python 2.7 UCS2, use this command<br/>pip install https://download.pytorch.org/whl/cu80/torch-1.0.1.post2-cp27-cp27m-linux_x86_64.whl",

    "stable,pip,linux,cuda9.0,python2.7": "pip install torch torchvision",

    "stable,pip,linux,cuda10.0,python2.7":
      "pip install https://download.pytorch.org/whl/cu100/torch-1.0.1.post2-cp27-cp27mu-linux_x86_64.whl<br/>pip install torchvision<br/><br/># if the above command does not work, then you have python 2.7 UCS2, use this command<br/>pip install https://download.pytorch.org/whl/cu100/torch-1.0.1.post2-cp27-cp27m-linux_x86_64.whl",

    "stable,pip,linux,cudanone,python3.5":
      "pip3 install https://download.pytorch.org/whl/cpu/torch-1.0.1.post2-cp35-cp35m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cuda8,python3.5":
      "pip3 install https://download.pytorch.org/whl/cu80/torch-1.0.1.post2-cp35-cp35m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cuda9.0,python3.5": "pip3 install torch torchvision",

    "stable,pip,linux,cuda10.0,python3.5":
      "pip3 install https://download.pytorch.org/whl/cu100/torch-1.0.1.post2-cp35-cp35m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cudanone,python3.6":
      "pip3 install https://download.pytorch.org/whl/cpu/torch-1.0.1.post2-cp36-cp36m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cuda8,python3.6":
      "pip3 install https://download.pytorch.org/whl/cu80/torch-1.0.1.post2-cp36-cp36m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cuda9.0,python3.6": "pip3 install torch torchvision",

    "stable,pip,linux,cuda10.0,python3.6":
      "pip3 install https://download.pytorch.org/whl/cu100/torch-1.0.1.post2-cp36-cp36m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cudanone,python3.7":
      "pip3 install https://download.pytorch.org/whl/cpu/torch-1.0.1.post2-cp37-cp37m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cuda8,python3.7":
      "pip3 install https://download.pytorch.org/whl/cu80/torch-1.0.1.post2-cp37-cp37m-linux_x86_64.whl<br/>pip3 install torchvision",

    "stable,pip,linux,cuda9.0,python3.7": "pip3 install torch torchvision",

    "stable,pip,linux,cuda10.0,python3.7":
      "pip3 install https://download.pytorch.org/whl/cu100/torch-1.0.1.post2-cp37-cp37m-linux_x86_64.whl<br/>pip3 install torchvision",
    ...
    "preview,libtorch,windows,cudanone,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cpu/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cpu/libtorch-win-shared-with-deps-latest.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cpu/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cpu/libtorch-win-shared-with-deps-debug-latest.zip</a>",

    "preview,libtorch,windows,cuda8,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu80/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu80/libtorch-win-shared-with-deps-latest.zip</a>",

    "preview,libtorch,windows,cuda9.0,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu90/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu90/libtorch-win-shared-with-deps-latest.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu90/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu90/libtorch-win-shared-with-deps-debug-latest.zip</a>",

    "preview,libtorch,windows,cuda10.0,cplusplus":
      "Download here (Release version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu100/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu100/libtorch-win-shared-with-deps-latest.zip</a><br/><br> Download here (Debug version): <br/><a href='https://download.pytorch.org/libtorch/nightly/cu100/libtorch-win-shared-with-deps-latest.zip'>https://download.pytorch.org/libtorch/nightly/cu100/libtorch-win-shared-with-deps-debug-latest.zip</a>",
  };
