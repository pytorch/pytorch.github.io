...
function selectedOption(option, selection, category) {
  ...
  if (category === "pm") {
    ...
    if (selection.id !== "libtorch" && elements["cplusplus"].classList.contains("selected")) {
      ...
      $(elements["python3"]).addClass("selected");
...
function commandMessage(key) {
  var object = {
    ...
    "stable,conda,linux,cuda9.2,python3":
      "conda install pytorch torchvision cudatoolkit=9.2 -c pytorch",

    "stable,conda,linux,cuda10.1,python3":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch",

    "stable,conda,linux,cudanone,python3":
      "conda install pytorch torchvision cpuonly -c pytorch",
    ...
    "stable,conda,macos,cuda9.2,python3":
      "conda install pytorch torchvision -c pytorch<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",

    "stable,conda,macos,cuda10.1,python3":
      "conda install pytorch torchvision -c pytorch<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",

    "stable,conda,macos,cudanone,python3":
      "conda install pytorch torchvision -c pytorch",
    ...
    "stable,conda,windows,cuda9.2,python3":
      "conda install pytorch torchvision cudatoolkit=9.2 -c pytorch -c defaults -c numba/label/dev ",

    "stable,conda,windows,cuda10.1,python3":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch",

    "stable,conda,windows,cudanone,python3":
      "conda install pytorch torchvision cpuonly -c pytorch",
    ...
    "stable,pip,macos,cuda9.2,python3":
      "pip3 install torch torchvision<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",

    "stable,pip,macos,cuda10.1,python3":
      "pip3 install torch torchvision<br /># MacOS Binaries dont support CUDA, install from source if CUDA is needed",

    "stable,pip,macos,cudanone,python3": "pip3 install torch torchvision",
    ...
    "stable,pip,windows,cudanone,python3":
      "pip3 install torch==1.4.0+cpu torchvision==0.5.0+cpu -f https://download.pytorch.org/whl/torch_stable.html",

    "stable,pip,windows,cuda9.2,python3":
      "pip3 install torch==1.4.0+cu92 torchvision==0.5.0+cu92 -f https://download.pytorch.org/whl/torch_stable.html",

    "stable,pip,windows,cuda10.1,python3":
    ...
    "preview,conda,linux,cuda9.2,python3":
      "conda install pytorch torchvision cudatoolkit=9.2 -c pytorch-nightly",

    "preview,conda,linux,cuda10.1,python3":
      "conda install pytorch torchvision cudatoolkit=10.1 -c pytorch-nightly",

    "preview,conda,linux,cudanone,python3":
      "conda install pytorch torchvision cpuonly -c pytorch-nightly",
    ...
    "preview,conda,macos,cuda9.2,python3":
      "conda install pytorch torchvision -c pytorch-nightly",

    "preview,conda,macos,cuda10.1,python3":
      "conda install pytorch torchvision -c pytorch-nightly",

    "preview,conda,macos,cudanone,python3":
      "conda install pytorch torchvision -c pytorch-nightly",
    ...
    "preview,pip,macos,cuda9.2,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html<br /># On MacOS, we provide CPU-only packages, CUDA functionality is not provided",

    "preview,pip,macos,cuda10.1,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html<br /># On MacOS, we provide CPU-only packages, CUDA functionality is not provided",

    "preview,pip,macos,cudanone,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html",
    ...
    "preview,pip,linux,cudanone,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html",

    "preview,pip,linux,cuda9.2,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu92/torch_nightly.html",

    "preview,pip,linux,cuda10.1,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
    ...
    "preview,pip,windows,cudanone,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cpu/torch_nightly.html",

    "preview,pip,windows,cuda9.2,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu92/torch_nightly.html",

    "preview,pip,windows,cuda10.1,python3":
      "pip install numpy<br />pip install --pre torch torchvision -f https://download.pytorch.org/whl/nightly/cu101/torch_nightly.html",
