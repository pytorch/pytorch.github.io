...
function commandMessage(key) {
  var object = {
    ...
    "preview,pip,macos,cudanone,python2.7": "pip install torch torchvision",
    ...
    "preview,pip,macos,cudanone,python3.5": "pip3 install torch torchvision",
    ...
    "preview,pip,macos,cudanone,python3.6": "pip3 install torch torchvision",
    ...
    "preview,pip,macos,cudanone,python3.7": "pip3 install torch torchvision",
    ...
    "preview,pip,linux,cuda9.0,python2.7": "pip install torch torchvision",
    ...
    "preview,pip,linux,cuda9.0,python3.5": "pip3 install torch torchvision",
    ...
    "preview,pip,linux,cuda9.0,python3.6": "pip3 install torch torchvision",
    ...
    "preview,pip,linux,cuda9.0,python3.7": "pip3 install torch torchvision",
